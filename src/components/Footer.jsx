        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="mb-8 md:mb-0 ">
            ...
            <p className="leading-6 max-w-4xl">
              ...
              property. <br />Our mission is to bring your outdoor vision to life with
              creativity, expertise, and attention to detail.<br /> Whether you need a
              complete landscape design, garden maintenance, or hardscaping
              services, we have the skills and experience to exceed your
              expectations.
            </p>
          </div>
        </div>
